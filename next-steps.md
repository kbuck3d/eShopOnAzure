...
- [app/Basket.API.bicep](./infra/app/Basket.API.bicep) - Azure Container Apps resources to host the 'Basket.API' service.
- [app/Catalog.API.bicep](./infra/app/Catalog.API.bicep) - Azure Container Apps resources to host the 'Catalog.API' service.
- [app/Mobile.Bff.Shopping.bicep](./infra/app/Mobile.Bff.Shopping.bicep) - Azure Container Apps resources to host the 'Mobile.Bff.Shopping' service.
- [app/OrderProcessor.bicep](./infra/app/OrderProcessor.bicep) - Azure Container Apps resources to host the 'OrderProcessor' service.
- [app/Ordering.API.bicep](./infra/app/Ordering.API.bicep) - Azure Container Apps resources to host the 'Ordering.API' service.
- [app/PaymentProcessor.bicep](./infra/app/PaymentProcessor.bicep) - Azure Container Apps resources to host the 'PaymentProcessor' service.
- [app/WebApp.bicep](./infra/app/WebApp.bicep) - Azure Container Apps resources to host the 'WebApp' service.
- [app/WebhookClient.bicep](./infra/app/WebhookClient.bicep) - Azure Container Apps resources to host the 'WebhookClient' service.
- [app/Webhooks.API.bicep](./infra/app/Webhooks.API.bicep) - Azure Container Apps resources to host the 'Webhooks.API' service.
- [app/eShop.AppHost.bicep](./infra/app/eShop.AppHost.bicep) - Azure Container Apps resources to host the 'eShop.AppHost' service.
